...
class PlantationsControllerTest < ActionController::TestCase
  ...
  test "should create plantation" do
    assert_difference('Plantation.count') do
      post :create, plantation: { Farmerid: @plantation.Farmerid, Pname: @plantation.Pname, Productid: @plantation.Productid, quality: @plantation.quality }
    end
  ...
  test "should update plantation" do
    patch :update, id: @plantation, plantation: { Farmerid: @plantation.Farmerid, Pname: @plantation.Pname, Productid: @plantation.Productid, quality: @plantation.quality }
    assert_redirected_to plantation_path(assigns(:plantation))
  end
